document.addEventListener("DOMContentLoaded", () => {
    ...
    const images = document.querySelectorAll<HTMLImageElement>(".zoomable");
    ...
    zoomButtons.forEach((button) => {
        button.addEventListener("click", () => {
            ...
            const targetImage = document.getElementById(targetId) as HTMLImageElement | null;
            ...
            const imageContainer = targetImage.closest<HTMLElement>(".image-container");
            if (imageContainer) {
