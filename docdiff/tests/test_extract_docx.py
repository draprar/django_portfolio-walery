...
def test_extract_docx_blocks_paragraph(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("docdiff.extractors.extract_docx.Document", lambda _: fake_doc)
...
def test_docx_extractor_wrapper(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("docdiff.extractors.extract_docx.extract_docx_blocks", fake_extract)
