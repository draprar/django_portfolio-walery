document.addEventListener('DOMContentLoaded', () => {
    const mirrorBtn = document.getElementById('mirror-btn-articulators');
    const videoContainer = document.getElementById('video-container-articulators');
    const videoPreview = document.getElementById('video-preview-articulators');
